...
/// <summary>
/// Shared UDP discovery client (port 9876). Migrated from
/// <c>ShaPrint.WpfApp/Services/Client/DiscoveryClient.cs</c> (Task 4) as an injectable
/// class. Pure networking over <c>ShaPrint.Core</c> — no OS-specific API.
/// </summary>
