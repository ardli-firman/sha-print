...
/// <summary>
/// Shared scan client (sends ScanRequestPayload to a server's port 9877 and reads the
/// response). Migrated from <c>ShaPrint.WpfApp/Services/Client/ScanClientService.cs</c>
/// (Task 4) as an injectable class. The WPF toast <c>INotificationService</c> is replaced by
/// the platform abstraction so the class stays UI-agnostic.
/// </summary>
