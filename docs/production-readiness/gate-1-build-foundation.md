...
- Canonical verification (2026-08-24): `pwsh -NoProfile -File scripts/verify-build.ps1` — restore exited 0, Release build exited 0, test exited 0; 392/392 passed, 0 failed, 0 skipped. TRX: `TestResults/ShaPrint.Tests.trx` (539,995 bytes, written 2026-08-24 09:46:10 local time).
...
- The fresh canonical Release build emitted 0 warnings and 0 errors. Gate 1 introduced no warning suppression.
